...
botkina_db.add_building("Взрослая поликлиника №4", "Орловская обл., г. Орёл, ул. Раздольная, д.57")
botkina_db.add_building("Детская поликлиника №4", "Орловская обл., г. Орёл, ул. Металлургов, д.80")
cur = botkina_db.conn.cursor()
cur.execute("select * from buildins;")
print(cur.fetchall())
